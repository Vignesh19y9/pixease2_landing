  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <section className="pb-10">
        ...
        <p className="text-lg">
          Last updated: Sep 9, 2022 Please read these terms and conditions
      ...
      <p>
        ...
        the app, or our trademarks in any way. You shouldn’t try to translate
        the app into other languages or make derivative versions. The app
        itself, and all the trademarks, copyright, database rights, and other
        intellectual property rights related to it, still belong to PixEase.
        PixEase is committed to ensuring that the app is as useful and efficient
        ...
        very clear to you exactly what you’re paying for. You should be aware
        that there are certain things that PixEase cannot take responsibility
        for the app not working at full functionality if you don’t give access
        to capture your screenshot. PixEase cannot always take responsibility
        ...
        avail of the Service, PixEase cannot accept responsibility. With respect
        to PixEase responsibility for your use of the app, when you’re using the
        app, it’s important to bear in mind that although we endeavor to ensure
        that it is updated and correct at all times, upon update of MacOS
        certain functionalities may encounter problems, PixEase accepts no
        liability for any loss, direct or indirect, you experience as a result
        of relying wholly on this functionality of the app. At some point, we
        may wish to update the app. The app is currently available on MacOS the
        requirements for these systems (and for any additional systems we decide
        to extend the availability of the app to) may change, and you’ll need to
        download the updates if you want to keep using the app. PixEase does not
        promise that it will always update the app so that it is relevant to you
        and/or works with the version that you have installed. However, you
        ...
        needed) delete it from your device. Changes to This Terms and Conditions
